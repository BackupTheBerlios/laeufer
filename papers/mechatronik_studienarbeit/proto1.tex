...
drei Klassen von Nachrichten-Prioritäten, oder voll-Duplex-Kommunikation
unterstützen.\\
...
\begin{tabular}{ll}
{\bf Name}	& {\bf Bedeutung}\\
\hline

{\tt STX}	& Synchronous Transfer: Operationscode\\
{\tt ACK}	& Acknowledgement: Operationscode\\
{\tt more}	& Flag, welches indiziert, ob noch mehr Daten in diesem	Kommunikationsstrom folgen\\
{\tt size}	& Menge an folgenden Datenbytes\\
...
Ein Ausbleiben des Acknowledgements für eine bestimmte, implementierungs-
...
NOP-Anweisung den Bus freigibt. In diesem Fall werden R-Übertragungen von
...
\subsubsection{Fehlererkennung und -behandlung}
%-----------------------------------
...
erhöht, mit der expliziten Ausnahme einer {\tt SYS}-Übertragung (bei der er nur
mitgesandt, aber nicht erhöht wird).
