...
er\-wähnte Multiplexer war noch nicht vorgesehen), die Low-Side Switches waren nicht integriert und die andeschlossene Peripherie wurde durch einen SX28 
...
Wichtigste Kriterien bei der Auswahl waren dementsprechend: Preis, Anzahl I/O-Ports, Taktfrequenz (für die Kommunikation nach RS232-\-Standard wichtig),
...
Infineons SABC515-Familie bietet mit zum Teil integrierten RS232-\-Bauelementen eine reiche Auswahl für Kommunikationsanwendungen. Mit bis zu 24Mhz 
...
Die Microcontrollerreihe 68HC11 von Motorola wird bereits vielfach inder Autoindustrie genutzt. 
...
von Kommunikationsanwendungen schwierig. Motorola gleicht dies durch eine reiche Auswahl an Modellen mit integrierter Kommunikationslogik aus. 
...
Microchip ist in den USA für die PIC-Microcontroller bekannt. PIC sind schnelle RISC Microcontroller die sich gut für Kommunikationsanwendungen
...
Mit dem SX52 von Ubicom steht noch ein weiterer PIC-Microcontroller zur Auswahl. Mit acht interruptfähigen PIN's ist der SX52 nicht ganz so gut
...
\begin{table}
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|}
      ...
      \hline
      \emph{RS232}	                & Max202CWE & Dallas Semiconductor/MAXIM & 3,26 \\
      \hline
