...
Revision berücksichtigte dann eine Reihe
...
Registeradressierung anzukündigen, müssen die ersten vier Bit (den
...
Ein Ingenieure der die Aufgabe erhält ein SX-Assemblerprogramm zu schreiben,
...
\item[INTERRUPT-Segment] Benötigt man für ein Modul auch Routinen die
  ...
  am Ende der Makroliste stehen, daß alle Segmente
...
Um den Austausch von Daten sicher zu stellen, werden zwei Bänke
...
\item[Serielle Schnittstelle]\label{crRS232} Die serielle
  ...
  rückgewinnen. Um
  sicherzustellen, daß eine Zustandsänderung am Eingang registriert
