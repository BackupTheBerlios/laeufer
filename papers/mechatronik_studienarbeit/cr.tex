...
Das CALL-Segment ermöglicht also einen Unterprogrammaufruf ohne die 256-Byte Beschränkung bedenken zu müssen.
\item[DATA-Segment]
Wie bereits oben beschrieben stehen dem Programmierer 256 Register aus verschiedenen Bänken zur Verfügung. Um mit den Registeradressierungen nicht
...
Um den Austausch von Daten sicher zu stellen, werden zwei Bänke für den Austausch von Daten reserviert. Jedes Modul holt dort seine Eingabewerte ab und
 legt die Ergebnisse dort wieder ab.

\subsection{Implemetierungen}
Im folgenden werden Beispielhaft einige Module beschrieben.
\begin{description}
