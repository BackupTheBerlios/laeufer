...
Geht man davon aus das ein Ausgang zwei Zustände $low$ und $high$ einnehmen kann, und das jedes Zeitintervall $z_{i}$
In jedem Zeitintervall $z_{i}$ wählt man nun ein $t_{i}$ mit $0 < t_{i} < |z_{i}|$ ab welchem .

Jedes der kleinen Zeitintervalle $z_i$ repräsentiert einen 

Für eine monoton steigende Funktion wie in ------ Abbildung------ wechselt nun der Zustand von logisch 0 auf logisch
Innerhalb eines Zeitintervalls $z_i$ wechselt der 
reverse iterations
