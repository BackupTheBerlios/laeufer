...
Die Serielle Schnittstelle nutzt den Interrupt um ein korrektes Timing zu erreichen. Der Befehl RETIW kürzt den Zeitraum bis zum nächsten Rollover
Interrupt um den Betrag im Akkumulator W. So lässt sich die Frequenz relativ genau an den gewünschte Wert anpassen.
Bei einer Taktfrequenz von 50 MHz benötigt ein Zyklus 20 Nanosekunden (Bis auf Sprungbefehle benötigt jede Instruktion nur einen
Zyklus).
Die genaue Taktung erreicht man durch den Interrupt.
Bei einer Baudrate von 115200 muß alle x ns eine Abtastung auf eine eingehendes Signal erfolgen.
...
Um eine Frequenz von 115 Baud zu realisieren benötigt man eine 4 mal so hohe Abtastfrequenz.
...
Alle 256 Zyklen wird ein Rollover Interrupt ausgelöst bei einer Taktfrequenz von 50 MHz sind das 50.000.000 Instr/s = 20 Nano Sekunden pro Instr.

1/50000000=0.000 000 020 Sec -> 20 NanoSek;;  50_000_000 Cyc/sec 460800 Cyc/Sec ==> 108,5069444

TaktFrequenz/4*Baudrate = Anzahl der Instruktionen bis Interrupt ausgelöst werden soll.
...
Sicht eines Informatikers so ist hat die Schulung des Münchner Projektteams im Mai 2002 gezeigt. Auch in Zukunft wird die Platine dort auch in anderen
für den mechatronischen Bereich genutzt werden. Ebenso hat die Arbeit gezeigt wie wichtig der Austausch zwischen den Teammitgliedern und den
