...
Konkret angedacht wurde z.B. eine Anbindung eines GPS\footnote{Global
  Positioning System}-Systems über den CAN-Bus.  Die mechatronischen
Komponenten des Läufers verfügen über etliche Parameter, die man als
Fahrer einstellen können will.  Als Beispiel sei hier der
Antriebsstrang genannt.  Der soll es dem Fahrer z.B. ermöglichen, bei
vollen Batterien und kurzer Strecke alleine elektrisch zu fahren, und
die Pedale ohne Widerstand zu benutzen.
...
\item[Display] Um die Informationen für den Fahrer darzustellen.
  Aufgabe des Displays ist es, das Armaturenbrett eines PKW zu
  ersetzen.
...
nutzbar zu machen.  Die Software ist vor allem ein
Kommunikationssystem zwischen PDA und den im Fahrzeug verteilten
Komponenten.  Dies ist nötig, da im PDA-Bereich zwar die aus dem
PC-Markt bekannten Schnittstellen und Kommunikationsprotokolle zur
Verfügung stehen\footnote{Beispiele hierfür sind die serielle
  Schnittstelle, die Infrarottechnik IrDA sowie USB}. Im bereich der
mechatronischen Systeme stehen die aus der PC-Technik stammenden
Schnittstellen jedoch im Allgemeinen nicht zur Verfügung.
...
soll.  Eine Gliederung nach Betriebssystem ist hilfreich, da sich auch
der PDA-Markt sehr gut nach der Systemsoftware der PDAs unterteilen
läßt.  Weiter unten wird dies zur Vorauswahl des PDAs ausgenutzt.

\subsubsection{Anforderungen an die Software}
\begin{description}
\item[Multitasking] Die Anforderung nach Multitasking ergibt sich
  ...
  basierten Navigationssystems nicht wünschenswert ist.
...
\begin{description}
\item[PalmOS] Das System ,,PalmOS'' wurde von der Firma 3Com entwickelt und
  ...
  des Marktführers ins Auge gefaßt wurden.  Bei den Geräten kann
  man aufgrund der großen Verbreitung mit einer guten Akzeptanz
  seitens der Nutzers des Läufers rechnen.  Auch wird ein eventueller
  Kunde mit hoher Wahrscheinlichkeit schon über ein solches Gerät
  verfügen.
  ...
  geforderte Erweiterbarkeit wird nicht in dem Masse sicherstellt, wie
...
\item[Entscheidung] Letztlich war die Entscheidung zwischen Windows
  ...
  unabänderlichen Betriebssystem wären solche Probleme eventuell nicht
  lösbar.
...
Die Wahl fiel letztlich auf einen Compaq IPAQ, da das Gerät nach den
