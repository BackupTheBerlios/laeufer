...
\begin{figure}[h]
  ...
  \caption{Die durch das DPI abzudeckenden Schnittstellen (schraffiert)}
  \label{mw_schnittstellen}
\end{figure}

Abbildung \ref{mw_schnittstellen} zeigt die grobe Architektur des
DPI.  Alle schraffiert dargestellten Bereiche werden durch das DPI
