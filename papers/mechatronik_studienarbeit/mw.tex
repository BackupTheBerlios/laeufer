...
können.  Zusätzlich sind sind die mobilen Kleicnrechner sehr stark auf
...
abgedeckt.  Der Entwickler einer mechatronischen Komponenente
...
Wie aus Abbildung \ref{mw_schnittstellen} ebanfalls hervorgeht, hat
...
hinnaus ausdehnt.  In Folge dessen muss die Entwicklung der GUI
ausserhalb diser Arbeit beim Design des DPI Berücksichtigung finden.

Auf diese beiden Aufgabenfelder des DPI Treiber - CAN-Bus sowie
Treiber - GUI soll im folgenden detailiert eingegangen werden.  Dem
voran stehen einige Anforderungen, die sich aus den schon weiter oben
in Kapitel \ref{aufgabe_kapitel} auf Seite \pageref{aufgabe_kapitel}ff
...
PDA Software und Platine Rechnung trägt.
...
mit.  \emph{Signifikant} meint in diesem Zusammenhang, dass nur solche
...
PDA davon unterrichtet werden muss.  Nicht signifikant sind die
...
eines Blinkers schenit dies nicht kritisch zu sein, aber das
...
Ziel der Entwicklung des DPI ist es, die Entwicklung darauf
aufsetzender Komponenten so einfach wie möglich zu machen, da die
Entwickler, die die Komponenten entwickeln werden, sich neben der
...
Implemenierungsdetails nutzen jedoch bewusst keine Sprachmittel, die
...
Um die Funktionsweise fassbar zu machen, soll hier ein kleiner
