...
\overlays{4}{%
  \begin{slide}{Aufgabe dieser Arbeit}
    \begin{center}
      ...
      \onlySlide*{2}{Platinen samt Betriebssystem (2)}%
...
\begin{slide}{Ziele}
Das erstellte Mechatronik-Framework soll
\begin{itemize}
  \item später von den Ingenieuren handhabbar,
  \item durch Industriepartner förderbar,
...
\begin{slide}{Übersicht über das Folgende}
Weg eines Benutzerwunsches:
\begin{itemize}
  \item Benutzer drückt Blinker-Knopf
