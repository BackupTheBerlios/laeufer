...
entschlossen uns dazu, das Session-Protokoll für eine
Master-Slave-Kommunikation auszulegen, da dies der angestrebten unmittelbaren
Kontrolle der Peripherie durch ein zentrales System entsprach,
wohingegen wir das Netzwerk-Protokoll, das auch die Aufgabe der
Adressierung bestimmter Clients übernehmen sollte, ein
Single-Master-Multi-Slave-System bildete, aus den gleichen Gründen.\\
...
beliebig im Rahmen des von CAN Ermöglichten erfolgen.
	...
	signifikant andere Aufgaben wahr, die hier aufgeführt werden und bezüglich ihrer Abdeckung der geforderten
	Funktionalität überprüft werden sollen.

		\subsubsection{Aufgaben des LLO-Protokolls}
		Die Aufgaben des LLO-Protokolls stellen die der untereren Schicht dar, sie sind wie folgt:
		\begin{enumerate}
		  ...
		  \item{Sicherstellung der Erfüllung des ersten Korrektheitskriteriums}
		  \item{Busmastering}
		\end{enumerate}
