...
(die ja zu zwei Dritteln schon von CAN erfüllt wurden). 
In diesem Rahmen stellt es zus\"atzliche Sicherheitsmechanismen zur Verf\"ugung. Der
Grundgedanke ist der eines eingeschr\"ankten Multi-Master-Protokolles,
in dem zwar ein expliziter einzelner Busmaster existiert, alle anderen
Busteilnehmer jedoch in explizit daf\"ur vorgesehenen Intervallen miteinander
konkurrieren. Diese letztere F\"ahigkeit ist f\"ur Meldungen von
der Peripherie an den Busmaster intendiert, die Spezifikiation verbietet
jedoch keine Kommunikation von Ger\"aten untereinander (was im Rahmen dieses
Projektes jedoch nicht zu verwenden geplant ist).
Die vollstaendige Protokollspezifikation findet sich in Anhang \ref{llo-proto}.
