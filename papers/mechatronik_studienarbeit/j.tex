...
Datenübertragung zwischen ihnen ist sogar essenziell-- Blinker und Scheibenwischer können nicht, oder jedenfalls
...
eines Datenübertragungssysteme werden beschrieben und bewertet werden. Am Schluß erfolgt eine Beschreibung der gewählten
...
%% -- fixme -- %%
        ...
        auch außerhalb der Automobilbranche genutzt.
...
nur, Datenpakete ``an alle interessierten Zuhörer'' zur Verfügung zu stellen. Zur gerichteten, sequentiellen Datenübertragung
...
Betrachten wir einige der üblichen Möglichkeiten zur Implementierung eines Kommunikationsprotokolles:
        ...
        durch alle Kommunikationsteilnehmer, ihre konfigurierbaren Felder und deren Typen\footnote{mit einem sehr eingeschränkten, mschinell
        ...
        dieses, primär zu Automationszwecken gedacht. Die Spezifikation dieses Protokolles ist jedoch, wie bei DeviceNet, nur auf
        ...
        verfügbarkeit existierender Implementierungen der andren genannten Protokolle für die von uns gewählte Plattform jedoch andererseits
	...
	w\"are in jedem Fall n\"otig; es war uns nicht m\"oglich, frei verf\"ugbare Implementierungen der genannten Protokolle f\"ur den
	SX-Prozessor aufzutreiben.
...
schien uns dieses Design wartbarer als ein komplett integriertes solches.\\
...
dieser M\"oglichkeit zur schnellen Meldung von Fehlerzustands\"uberg\"angen sinnvoll.
...
läßt\footnote{Die vollständige Protokollspezifikation findet sich als Anhang (Sektion {\ref{llo-proto}}).}.
	...
	hierf\"ur ist aufwendiger, da die Wahrscheinlichkeitsfunktion selbst wesentlich komplexer ist; die
	prinzipielle Vorgehensweise ist jedoch identisch.
...
Korrektheitskriteriums\footnote{Die vollständige Protokollspezifikation findet sich als Anhang (Sektion \ref{llz-proto}).}.
	...
	\"uberl\"a\ss t es die Handhabung gr\"o\ss erer Mengen von Teilnehmern dem darunterliegenden LLO-Protokoll).
        ...
        Implementierern überlassen, um nach genauerer Auswahl der zu verendenden Peripherie eine Abstimmung deren Priorit\"aten untereinander
	...
	\begin{enumerate}
	  ...
	  \item{Im Fehlerfall k\"onnen neuere Botschaften \"altere auch serverseitig \"uberschreiben und unn\"otigen Neuversand
