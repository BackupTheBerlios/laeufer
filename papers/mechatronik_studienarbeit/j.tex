...
Schlussendlich fiel die Wahl auf das CAN-Protokoll, nicht nur aufgrund der guten Feature-Abdeckung, sondern auch
...
Betrachten wir einige der üblichen Möglichkeiten zur Implementierung eines Kommunikationsprotokolles:
	...
	Das Smart Distributed System \ref{SDS}, von Honeywell Inc. entwickelt, ist ein primär zur Automatisierung von
	...
	\subsection{CANopen}
	Das CANopen-Protokoll \ref{CANopen} ist ein Protokoll, das sich durch Reichtum an Features und Umfang auszeichnet und seit 1995
	...
	DeviceNet \ref{DeviceNet}, ein mit SDS vergleichbares Protokoll der {\it Open DeviceNet Vendor Association}, ist, wie
	...
	merklichen Vorteile gegenüber einem eigenen solchen erwirkt hätte.
