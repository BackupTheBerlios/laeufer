...
garantiert wird. Kommt die Übertragung nicht zustande, muß ein Fehler auf
...
sind wie Responses aufgebaut, habenals Transmissionsoperation (s. 1.3) jedoch
...
\begin{tabular}{cp{0.8 cm}p{3.5 cm}}
...
\paragraph{Transmissionsoperationen}\label{j-app-1.3.1}
%------------------------------
