...
\chapter{Protokoll-Layer 0: LLZ-Protokoll, Version 0}
%-------------------------------------------
...
die entsprechenden Zustände und Übergänge finden sich in \ref{j-app-3.1}.


\subsection{Empfänger}\label{j-app-3.1}
%--------------
...
\subsection{Initialisierung des Empfängers}
%-----------------------------------
